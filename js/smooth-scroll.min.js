...
!function(e, t) {
    ...
    "use strict";
    var t, n, o, r, a, i = {}, c = "querySelector"in document && "addEventListener"in e, u = {
    ...
    i.animateScroll = function(n, i, c) {
        ...
        if (h || y) {
            var O = e.pageYOffset;
            o || (o = e.document.querySelector(f.selectorHeader)),
            r || (r = v(o));
            var S, I, H = h ? n : m(y, r, parseInt(f.offset, 10)), E = H - O, j = p(), w = 0;
            h || b(n, f.updateURL);
            var C = function(t, o, r) {
                var a = e.pageYOffset;
                (t == o || a == o || e.innerHeight + a >= j) && (clearInterval(r),
                h || (y.focus(),
                document.activeElement.id !== y.id && (y.setAttribute("tabindex", "-1"),
                y.focus(),
    ...
    var y = function(e) {
        if (0 === e.button && !e.metaKey && !e.ctrlKey) {
            ...
            if (n && "a" === n.tagName.toLowerCase()) {
                if (n.origin !== location.origin || n.pathname !== location.pathname)
                    return;
                e.preventDefault();
    ...
    i.init = function(n) {
        ...
        o && e.addEventListener("resize", O, !1))
    }
    ,
    i
});
