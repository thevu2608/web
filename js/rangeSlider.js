...
!function(t) {
    ...
    t.widget = function(e, i, s) {
        var n, o, a, u = {}, r = e.split(".")[0], h = r + "-" + (e = e.split(".")[1]);
        return s || (s = i,
        i = t.Widget),
    ...
    t.widget.bridge = function(e, s) {
        ...
        t.fn[e] = function(o) {
            ...
            return a ? this.length || "instance" !== o ? this.each(function() {
                ...
                return "instance" === o ? (r = s,
                !1) : s ? t.isFunction(s[o]) && "_" !== o.charAt(0) ? (i = s[o].apply(s, u),
            ...
            }) : r = void 0 : (u.length && (o = t.widget.extend.apply(null, [o].concat(u))),
            this.each(function() {
                var e = t.data(this, n);
                e ? (e.option(o || {}),
        ...
        _classes: function(e) {
            function i(i, o) {
                ...
                for (u = 0; u < i.length; u++)
                    a = n.classesElementLookup[i[u]] || t(),
                    a = t(e.add ? t.unique(a.get().concat(e.element.get())) : a.not(e.element).get()),
                    n.classesElementLookup[i[u]] = a,
                    s.push(i[u]),
                    o && e.classes[i[u]] && s.push(e.classes[i[u]])
            }
            var s = []
              , n = this;
            return e = t.extend({
    ...
    t.each({
        ...
        t.Widget.prototype["_" + e] = function(s, n, o) {
            ...
            n.complete = o,
            n.delay && s.delay(n.delay),
            a && t.effects && t.effects.effect[u] ? s[e](n) : u !== e && s[u] ? s[u](n.duration, n.easing, o) : s.queue(function(i) {
                t(this)[e](),
                o && o.call(s[0]),
                i()
            })
